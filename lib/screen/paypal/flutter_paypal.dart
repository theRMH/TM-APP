...
import 'package:magicmate_user/screen/paypal/src/screens/complete_payment.dart';
...
class UsePaypalState extends State<UsePaypal> {
  ...
  fun(){
    if (pressed < 2) {
      ...
      Fluttertoast.showToast(msg: 'Press back ${3 - pressed} more times to cancel transaction');
