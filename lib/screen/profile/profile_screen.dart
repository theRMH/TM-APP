...
import 'package:magicmate_user/screen/myTicket/myticket_screen.dart';
          ...
          child: Column(
            children: [
              ...
              GetBuilder<PageListController>(
                builder: (context) {
                  final pagelist =
                      pageListController.pageListInfo?.pagelist ?? [];
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            Spacer(),
            Icon(Icons.arrow_forward_ios, size: 17, color: BlackColor),
            SizedBox(width: 20),
          ],
        ),
      ),
