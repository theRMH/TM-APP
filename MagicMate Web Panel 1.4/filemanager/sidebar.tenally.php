      ...
      <nav class="sidebar-main" aria-label="">
         ...
         <div id="sidebar-menu">
            <ul class="sidebar-links" id="simple-bar">
               ...
               <li class="sidebar-list">
                  <a class="sidebar-link sidebar-title" href="javascript:void(0);">
                  <i data-feather="pen-tool"></i><span>Tenally Submissions</span></a>
                  <ul class="sidebar-submenu">
                     <li><a href="list_tenally_scripts.php">Script Submissions</a></li>
                     <li><a href="list_tenally_artists.php">Artist Submissions</a></li>
                  </ul>
               </li>
             </ul>
         </div>
